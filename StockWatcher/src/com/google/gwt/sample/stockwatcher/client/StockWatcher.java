...
public class StockWatcher implements EntryPoint {
	...
	private void updateTable(StockPrice price) {
		...
		// Changing color does not working "Uncaught TypeError: Cannot read property
		// 'setStyleName_0_g$' of null"
		// Change the color of text in the Change field based on its value.
		/*
		 * String changeStyleName = "noChange"; if (price.getChangePercent() < -0.1f) {
		 * changeStyleName = "negativeChange"; } else if (price.getChangePercent() >
		 * 0.1f) { changeStyleName = "positiveChange"; }
		 * 
